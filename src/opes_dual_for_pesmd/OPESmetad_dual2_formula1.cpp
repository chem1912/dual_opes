...
//neighbour list stuff
  ...
  double deltaH0; //Inital Value of H1-H0
  bool deltaH0_isAssigned;
  double deltaH_; //H1-H0-deltaH0
...
//bias_mode id: scheme1_convergence_convergence_V11 (s1ccv11)= 1
//         scheme1_convergence_convergence_V12 (s1ccv12)= 2
//         scheme1_convergence_convergence_V2 (s1ccv2)= 3
//         scheme1_convergence_exploration_V11 (s1cev11)= 4
//         scheme1_convergence_exploration_V12 (s1cev12)= 5
//         scheme1_convergence_exploration_V2 (s1cev2)= 6
//         scheme2_convergence_convergence_V1 (s2ccv1)= 7
//         scheme2_convergence_convergence_V21 (s2ccv21)= 8
//         scheme2_convergence_convergence_V22 (s2ccv22)= 9

struct s1ccv11 { static const int bias_mode=1; };
typedef OPESmetad_dual2<s1ccv11> OPESmetad_s1ccv11;
PLUMED_REGISTER_ACTION(OPESmetad_s1ccv11,"OPES_METAD_SCHEME1_CONVERGENCE_CONVERGENCE_V11")

struct s1ccv12 { static const int bias_mode=2; };
typedef OPESmetad_dual2<s1ccv12> OPESmetad_s1ccv12;
PLUMED_REGISTER_ACTION(OPESmetad_s1ccv12,"OPES_METAD_SCHEME1_CONVERGENCE_CONVERGENCE_V12")

struct s1ccv2 { static const int bias_mode=3; };
typedef OPESmetad_dual2<s1ccv2> OPESmetad_s1ccv2;
PLUMED_REGISTER_ACTION(OPESmetad_s1ccv2,"OPES_METAD_SCHEME1_CONVERGENCE_CONVERGENCE_V2")

struct s1cev11 { static const int bias_mode=4; };
typedef OPESmetad_dual2<s1cev11> OPESmetad_s1cev11;
PLUMED_REGISTER_ACTION(OPESmetad_s1cev11,"OPES_METAD_SCHEME1_CONVERGENCE_EXPLORATION_V11")

struct s1cev12 { static const int bias_mode=5; };
typedef OPESmetad_dual2<s1cev12> OPESmetad_s1cev12;
PLUMED_REGISTER_ACTION(OPESmetad_s1cev12,"OPES_METAD_SCHEME1_CONVERGENCE_EXPLORATION_V12")

struct s1cev2 { static const int bias_mode=6; };
typedef OPESmetad_dual2<s1cev2> OPESmetad_s1cev2;
PLUMED_REGISTER_ACTION(OPESmetad_s1cev2,"OPES_METAD_SCHEME1_CONVERGENCE_EXPLORATION_V2")

struct s2ccv1 { static const int bias_mode=7; };
typedef OPESmetad_dual2<s2ccv1> OPESmetad_s2ccv1;
PLUMED_REGISTER_ACTION(OPESmetad_s2ccv1,"OPES_METAD_SCHEME2_CONVERGENCE_CONVERGENCE_V1")

struct s2ccv21 { static const int bias_mode=8; };
typedef OPESmetad_dual2<s2ccv21> OPESmetad_s2ccv21;
PLUMED_REGISTER_ACTION(OPESmetad_s2ccv21,"OPES_METAD_SCHEME2_CONVERGENCE_CONVERGENCE_V21")

struct s2ccv22 { static const int bias_mode=9; };
typedef OPESmetad_dual2<s2ccv22> OPESmetad_s2ccv22;
PLUMED_REGISTER_ACTION(OPESmetad_s2ccv22,"OPES_METAD_SCHEME2_CONVERGENCE_CONVERGENCE_V22")
...
//output components
  ...
  if(mode::bias_mode==2 || mode::bias_mode==3 || mode::bias_mode==5 || mode::bias_mode==6 || mode::bias_mode==9){
    keys.addOutputComponent("H0","default","the part potential energy of H0 used for reweighting");
    keys.addOutputComponent("H1","default","the part potential energy of H1 used for reweighting");
...
//other compulsory input
  ...
  switch(mode::bias_mode)
  {
    ...
    case 2:
        bias_prefactor_=-1;
        log.printf("  case 2 BIAS_PREFACTOR = %f\n",bias_prefactor_);
        break;
    case 3:
        bias_prefactor_=1.-1./biasfactor_;
        log.printf("  case 3 BIAS_PREFACTOR = %f\n",bias_prefactor_);
        break;
    case 5:
        bias_prefactor_=-1;
        log.printf("  case 5 BIAS_PREFACTOR = %f\n",bias_prefactor_);
        break;
    case 6:
        plumed_massert(!std::isinf(biasfactor_),"BIASFACTOR=inf is not compatible with EXPLORE mode");
        bias_prefactor_=biasfactor_-1;
        log.printf("  case 6 BIAS_PREFACTOR = %f\n",bias_prefactor_);
        break;
    case 7:
        bias_prefactor_=1.-1./biasfactor_;
        log.printf("  case 7 BIAS_PREFACTOR = %f\n",bias_prefactor_);
        break;
    case 8:
        bias_prefactor_=1./biasfactor_;
        log.printf("  case 8 BIAS_PREFACTOR = %f\n",bias_prefactor_);
        break;
    case 9:
        bias_prefactor_=-1./biasfactor_;
        log.printf("  case 9 BIAS_PREFACTOR = %f\n",bias_prefactor_);
        break;
  }
  ...
  if(getRestart())
  {
    ...
    if(ifile.FileExist(restartFileName))
    {
      ...
      else
      {
        ...
        KDEnorm_=mode::bias_mode==6?counter_:sum_weights_;
        if(!no_Zed_)
        {
          double sum_uprob=0;
...
//printing some info
  ...
  if(mode::bias_mode==6 || adaptive_sigma_)
...
//do update
  if(getStep()%stride_==0 && (excluded_region_==NULL || excluded_region_->get()==0))
  {
    ...
    if(adaptive_sigma_)
    {
      const double factor=mode::bias_mode==6?1:biasfactor_;
    ...
    if(!fixed_sigma_)
    {
      const double size=mode::bias_mode==6?counter_:neff; //for EXPLORE neff is not relevant
